...
| **0.7.0** | Posts filter & sort completeness | M20 | ⏳ In progress | [specs/v0.7-posts-filter-sort.md](specs/v0.7-posts-filter-sort.md) |
| **0.8.0** | Users filter & sort completeness | M21 | 📋 Planned | [specs/v0.8-users-filter-sort.md](specs/v0.8-users-filter-sort.md) |
