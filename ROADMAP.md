...
| **0.9.0** | Minor enhancements grab-bag | M22 | ⏳ In progress | [specs/v0.9-minor-enhancements.md](specs/v0.9-minor-enhancements.md) |

> Milestone numbers continue the `PROGRESS.md` sequence (last used: M21). The gap M11–M13 is
